...
Route::group(['prefix' => 'vehicle'], function () {
    ...
    Route::group(['prefix' => 'model'], function () {
        Route::group(['middleware' => 'allowedIncludes:marques,types'], function () {
