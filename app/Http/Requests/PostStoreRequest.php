...
class PostStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'year_of_manufacture' => ['required', 'date', 'date_format:Y'],
            'production_year' => ['required', 'date', 'date_format:Y'],
            'circulation_date' => ['required', 'date', 'date_format:Y-m-d'],
            'technical_revision' => ['required', 'date', 'date_format:Y-m-d'],
